...
export const BUTTONS = {
    ...
    defaultButtons: {
        openMenu: openMenuGrey,
        closeMenu: closeArrowGrey
    },
    redStyleButtons: {
        openMenu: openMenuRed,
        closeMenu: closeArrowRed
    },
    tealStyleButtons: {
        openMenu: openMenuTeal,
        closeMenu: closeArrowTeal
    },
    purpleStyleButtons: {
        openMenu: openMenuPurple,
        closeMenu: closeArrowPurple
    },
    blueStyleButtons: {
        openMenu: openMenuBlue,
        closeMenu: closeArrowBlue
    },
    greenStyleButtons: {
        openMenu: openMenuGreen,
        closeMenu: closeArrowGreen
    },
    orangeStyleButtons: {
        openMenu: openMenuOrange,
        closeMenu: closeArrowOrange
    }
}